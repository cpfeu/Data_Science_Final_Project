...
if __name__ == '__main__':
    ...
    for ticker in GlobalConfig.TICKER_LIST:
        # ==================== Parse Stock Data ====================
        stock_parser = StockParser(ticker=ticker, interval=GlobalConfig.ONE_MIN_INTERVAL)
        ...
        combined_visualizer = CombinedVisualizer(stock_ticker=ticker)
        ...
        #                                              num_days=1)
        combined_visualizer.plot_distribution_comparison(perform_k_s_test=True,
                                                         stock_feature=GlobalConfig.ABS_VOL,
